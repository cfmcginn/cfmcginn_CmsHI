...
void makeJtVarPanel(const char* fileName1, Int_t setNum, const char* jtVarIn, Bool_t logY = false, const char* subOrLead = "", const char* fileName2 = "", const char* fileTag2 = "")
{
  TCanvas* jtVarPanel_p = new TCanvas(Form("%s%sPanel_%s", algType[setNum], jtVarIn, fileTag1), Form("%s%sPanel_%s", algType[setNum], jtVarIn, fileTag1), 1);
  ...
  if(strcmp(fileName2, "") != 0){
    overFile_p = new TFile(fileName2, "UPDATE");

    addJtHistToPanel_OVER(overFile_p, fileTag2, jtVarPanel_p, setNum, jtVarIn, 70, 100, 1, logY, subOrLead);
    addJtHistToPanel_OVER(overFile_p, fileTag2, jtVarPanel_p, setNum, jtVarIn, 50, 70, 2, logY, subOrLead);
    addJtHistToPanel_OVER(overFile_p, fileTag2, jtVarPanel_p, setNum, jtVarIn, 30, 50, 3, logY, subOrLead);
    addJtHistToPanel_OVER(overFile_p, fileTag2, jtVarPanel_p, setNum, jtVarIn, 20, 30, 4, logY, subOrLead);
    ...
    claverCanvasSaving(jtVarPanel_p, Form("../pngDir/%s%sPanel_%s_c", algType[setNum], jtVarIn, fileTag1), "png");
    jtVarPanel_p->Write();
  }
...
void cfmDiJet_JtVarPlots(const char* inName, const char* outName, Bool_t montecarlo = false, const char* inName2 = "", const char* fileTag2 = "")
{
